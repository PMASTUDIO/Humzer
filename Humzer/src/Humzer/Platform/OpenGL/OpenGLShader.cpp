...
namespace Humzer {
	...
	OpenGLShader::OpenGLShader(const std::string& vertexPath, const std::string& fragmentPath)
	{
		...
		if (isCompiled == GL_FALSE)
		{
			...
			HUM_CORE_ERROR("{0}", infoLog.data());
			HUM_CORE_ERROR("Vertex shader compilation failure!");
			return;
		}
		...
		if (isCompiled == GL_FALSE)
		{
			...
			HUM_CORE_ERROR("{0}", infoLog.data());
			HUM_CORE_ERROR("Fragment shader compilation failure!");
			return;
		}
		...
		if (isLinked == GL_FALSE)
		{
			...
			HUM_CORE_ERROR("{0}", infoLog.data());
			HUM_CORE_ERROR("Shader link failure!");
			return;
		}
